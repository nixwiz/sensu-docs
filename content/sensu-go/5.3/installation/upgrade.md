...
Instead of prepending `roundrobin` to a subscription in the client definition, Sensu Go offers round-robin check scheduling via a `round_robin` in the check definition.
